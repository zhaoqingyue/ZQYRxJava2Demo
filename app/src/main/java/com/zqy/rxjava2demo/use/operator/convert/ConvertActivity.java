...
public class ConvertActivity extends BaseActivity {
    ...
    protected void initData() {
        /**
         * 作用：
         * 1. 对事件序列中的事件 / 整个事件序列进行加工处理（即变换），使得其转变成不同的事件 / 整个事件序列
         *
         * 应用场景：
         * 1. 嵌套回调（Callback）
         */
    ...
    @OnClick({R.id.btn_convert_map, R.id.btn_convert_flatMap, R.id.btn_convert_concatMap, R.id.btn_convert_buffer})
